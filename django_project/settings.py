...
ADMINS = ENV('ADMINS')
ADMINS_EMAIL_BACKEND = ENV('ADMINS_EMAIL_BACKEND')
ADMINS_EMAIL_HOST = ENV('ADMINS_EMAIL_HOST')
ADMINS_EMAIL_PORT = ENV('ADMINS_EMAIL_PORT')
ADMINS_EMAIL_HOST_USER = ENV('ADMINS_EMAIL_HOST_USER')
ADMINS_EMAIL_HOST_PASSWORD = ENV('ADMINS_EMAIL_HOST_PASSWORD')
ADMINS_EMAIL_USE_TLS = ENV('ADMINS_EMAIL_USE_TLS')
ADMINS_EMAIL_USE_SSL = ENV('ADMINS_EMAIL_USE_SSL')
ADMINS_DEFAULT_FROM_EMAIL = ENV('ADMINS_DEFAULT_FROM_EMAIL')
ADMINS_EMAIL_SUBJECT_PREFIX = ENV('ADMINS_EMAIL_SUBJECT_PREFIX')

MANAGERS = ENV('MANAGERS')
MANAGERS_EMAIL_BACKEND = ENV('MANAGERS_EMAIL_BACKEND')
MANAGERS_EMAIL_HOST = ENV('MANAGERS_EMAIL_HOST')
MANAGERS_EMAIL_PORT = ENV('MANAGERS_EMAIL_PORT')
MANAGERS_EMAIL_HOST_USER = ENV('MANAGERS_EMAIL_HOST_USER')
MANAGERS_EMAIL_HOST_PASSWORD = ENV('MANAGERS_EMAIL_HOST_PASSWORD')
MANAGERS_EMAIL_USE_TLS = ENV('MANAGERS_EMAIL_USE_TLS')
MANAGERS_EMAIL_USE_SSL = ENV('MANAGERS_EMAIL_USE_SSL')
MANAGERS_DEFAULT_FROM_EMAIL = ENV('MANAGERS_DEFAULT_FROM_EMAIL')
MANAGERS_EMAIL_SUBJECT_PREFIX = ENV('MANAGERS_EMAIL_SUBJECT_PREFIX')
