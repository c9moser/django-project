...
ENV = Env(
        ...
        ADMINS=(list, [])
        ADMINS_EMAIL_BACKEND=(str, "django.core.mail.backends.console.EmailBackend"),
        ADMINS_EMAIL_HOST=(str, "localhost"),
        ADMINS_EMAIL_PORT=(int, 25),
        ADMINS_EMAIL_HOST_USER=(str, ""),
        ADMINS_EMAIL_HOST_PASSWORD=(str, ""),
        ADMINS_EMAIL_USE_TLS=(bool, False),
        ADMINS_EMAIL_USE_SSL=(bool, False),
        ADMINS_DEFAULT_FROM_EMAIL=(str, "webmaster@localhost"),
        ADMINS_EMAIL_SUBJECT_PREFIX=(str, "[Django Admin] "),
        MANMAGERS=(list, [])
        MANAGERS_EMAIL_BACKEND=(str, "django.core.mail.backends.console.EmailBackend"),
        MANAGERS_EMAIL_HOST=(str, "localhost"),
        MANAGERS_EMAIL_PORT=(int, 25),
        MANAGERS_EMAIL_HOST_USER=(str, ""),
        MANAGERS_EMAIL_HOST_PASSWORD=(str, ""),
        MANAGERS_EMAIL_USE_TLS=(bool, False),
        MANAGERS_EMAIL_USE_SSL=(bool, False),
        MANAGERS_DEFAULT_FROM_EMAIL=(str, "webmaster@localhost"),
        MANAGERS_EMAIL_SUBJECT_PREFIX=(str, "[Django Managers] "),
)
